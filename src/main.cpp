...
/*
    ...
    vector<std::string> faces
            {
                    FileSystem::getPath("resources/textures/skybox/distant_sunset_ft.jpg"),
                    FileSystem::getPath("resources/textures/skybox/distant_sunset_bk.jpg"),
                    FileSystem::getPath("resources/textures/skybox/distant_sunset_up.jpg"),
                    FileSystem::getPath("resources/textures/skybox/distant_sunset_dn.jpg"),
                    FileSystem::getPath("resources/textures/skybox/distant_sunset_rt.jpg"),
                    FileSystem::getPath("resources/textures/skybox/distant_sunset_lf.jpg")
            };
    ...
    Model ourModel("resources/objects/arena.obj");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        lightShader.use();
        lightShader.setVec3("light.direction", 0.0f, 0.0f, -1.0f);
        ...
        glBindTexture(GL_TEXTURE_2D, messiMap);
        for (unsigned int i = 0; i < 6; i++)
        {
            ...
            float angle = 20.0f * i;
            model = glm::rotate(model, glm::radians(angle), glm::vec3(glfwGetTime(),1.0,1.0));
            lightShader.setMat4("model", model);
